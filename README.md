...
| Observability | 🟢 WATCHING | Find the signal before noise becomes an incident. |
...
```text
PLATFORM       OpenShift · Kubernetes · Docker · VMware
DELIVERY       GitOps · CI/CD · Ansible · Helm · Bash · Python
OBSERVABILITY  Prometheus · Grafana · Exporters · Health checks
RECOVERY       PostgreSQL · MySQL · MongoDB · Velero · MinIO
```

## Operator protocol

> Design for the 3 a.m. alert: make the system legible, the rollback boring,
> and the recovery plan ready before it is needed.

## Comms uplink

[GitHub](https://github.com/trikto) · [LinkedIn](https://www.linkedin.com/in/gajanrajah) · [GitLab](https://gitlab.com/trikto) · [Medium](https://medium.com/@trikto) · [gajan.dev](https://gajan.dev)
